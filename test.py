...
def main(dataset, maxlen, model, num_blocks, num_heads, hidden_units):
    ...
    parser.add_argument('--dataset', default=dataset, type=str)  # name of dataset in ['DIGINETICA', 'YOOCHOOSE']
    parser.add_argument('--save_dir', default=model, type=str)  # name of dictionary save the results
    # exemplar
    ...
    for period in periods:
        ...
        valid_subseq, train_subseq = train_sampler.split_data(valid_portion=0.2, return_train=True)
